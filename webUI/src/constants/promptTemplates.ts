/**
 * @fileoverview Prompt 默认模板
 * @description 集中维护脚本分析、角色音色分析和 Qwen 音色生成文本模板
 * @module src/constants/promptTemplates
 */
...
export const DEFAULT_QWEN_VOICE_TEXT_TEMPLATE = '我是${charName}，初次见面，请多多指教。正在进行声线校准测试，一，二，三。这段音频将作为我的基准音色，希望能完美演绎接下来的故事，请多关照。'
